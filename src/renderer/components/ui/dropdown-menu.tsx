...
>(({ className, ...props }, ref) => <DropdownMenuPrimitive.SubContent ref={ref} className={cn('z-50 min-w-36 overflow-hidden rounded-md border bg-popover p-1 shadow-lg', className)} {...props} />);
